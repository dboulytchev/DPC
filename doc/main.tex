...
\newcommand{\defer}[1]{\left[{#1}\right]}
\newcommand{\alt}{\mid}
\newcommand{\seq}{\rhd}
...
\begin{array}{rcl}
  \mathscr{P} & = & \sigma \\
              &   & \epsilon \\
              &   & \defer{\mathscr P} \\
              &   & \mathscr{P} \alt \mathscr{P} \\
              &   & \mathscr{P} \seq \mathscr{P}
\end{array}
\]
...
\[
\begin{array}{rcl}
  \mathscr{R} & = & \mathscr{P}\times \mathscr {S}\\
              &   & \mathscr{S}
\end{array}
\]
...
\begin{figure}
  \[
  \begin{array}{cc}
    \trans{\sigma s}{\sigma}{s}&\ruleno{Term}\\[3mm]
    \trans{s}{\epsilon}{s},\,s\ne \epsilon&\ruleno{Eps}\\[3mm]
    \trans{s}{\defer{p}}{\inbr{p,\,s}}&\ruleno{Defer}\\[6mm]
    \trule{\trans{s}{p}{\inbr{p^\prime,\,s^\prime}}}
          {\trans{s}{p\seq q}{\inbr{p^\prime\seq q,\, s^\prime}}}&\ruleno{SeqDefer}\\[6mm]
    \trule{\trans{s}{p}{s^\prime}\quad\trans{s^\prime}{q}{r}}
          {\trans{s}{p\seq q}{r}}&\ruleno{Seq}\\[6mm]
    \trule{\trans{s}{p}{r}}
          {\trans{s}{p\alt q}{r}}&\ruleno{AltL}\\[6mm]
    \trule{\trans{s}{q}{r}}
          {\trans{s}{p\alt q}{r}}&\ruleno{AltR}          
  \end{array}
  \]
  \caption{Small-step Parsing Semantics}
  \label{ss-parsing}
\end{figure}
